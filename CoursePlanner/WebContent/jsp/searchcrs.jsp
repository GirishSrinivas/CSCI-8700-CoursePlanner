...
<body>
	...
	%>
				...
				<form action = "findcrs.jsp" method = "post">
					<div class="form-group">
				  		<label for="usr">Course ID:</label>
				  		<input type="text" class="form-control" placeholder="Course ID" name="c_no">
					</div>
					...
					<div class="button-container">
						...
						<div class="col-sm-4">
							<button type="submit" class="btn btn-success">Search Course</button>
						</div>
						<div class="col-sm-4"></div>
					</div>
				</form>
